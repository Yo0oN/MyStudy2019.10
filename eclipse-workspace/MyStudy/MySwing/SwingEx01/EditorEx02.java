...
public class EditorEx02 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditorEx02 frame = new EditorEx02();
	...
	public EditorEx02() {
		...
		btn1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int result = fileChooser.showOpenDialog(EditorEx02.this);
		...
		btn2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JFileChooser fileChooser = new JFileChooser("C:\\java\\TestFile");
				int result = fileChooser.showSaveDialog(EditorEx02.this);
