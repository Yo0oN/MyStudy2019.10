...
<div class="contents1"> 
	...
	<div class="con_title"> 
		<p style="margin: 0px; text-align: right">
			아이디님 환영합니다.
			<input type="button" value="" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='board_list1.jsp'">로그아웃</button>
			<input type="button" value="" class="btn_write btn_txt01" style="cursor: pointer;"  onclick="location.href='member_modify1.jsp'">회원수정</button>
		</p>
	</div> 
	<div class="contents_sub">	
		...
		<div class="align_right">		
			<input type="button" value="" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='board_write1.jsp'">쓰기</button>
		</div>
		<!--페이지넘버-->
