...
<%@page import="SimpleBoard01Model.SimpleBoard01DAO"%>d01DAO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	SimpleBoard01TO to = (SimpleBoard01TO) request.getAttribute("to");
				...
				<div class="btn_area">
					<div class="align_left">
						<button type="button" class="btn_list btn_txt02"
							...
							onclick="location.href='./Controller?action=list&seq=<%=seq%>'">목록</button>
						<button type="button" class="btn_list btn_txt02"
							style="cursor: pointer;"
