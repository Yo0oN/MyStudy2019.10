<%@page import="SimpleBoard01Model.SimpleBoard01TO"%>
<%@page import="SimpleBoard01Model.SimpleBoard01DAO"%>
...
<%
	// DB연결
	ArrayList<SimpleBoard01TO> boardLists = (ArrayList) request.getAttribute("boardLists");
  ...
  -->
			...
			<div class="align_right">
				<button type="button" class="btn_write btn_txt01"
					...
					onclick="location.href='./Controller?action=write'">쓰기</button>
			</div>
		</div>
	</div>
	<!--//하단 디자인 -->
