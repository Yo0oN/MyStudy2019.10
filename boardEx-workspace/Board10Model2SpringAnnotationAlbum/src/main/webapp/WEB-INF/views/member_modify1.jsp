...
<body>
	...
	<div class="contents1">
		...
		<form action="./member_modify_ok.do" method="post" name="frm">
					...
					<table>
						<tr>
							...
							<td class="top" colspan="3"><input type="text" name="id"
								value="<%=id%>" class="board_write_input_100" readonly /></td>
						</tr>
						<tr>
							<th>이름</th>
							<td colspan="3"><input type="text" name="name"
								value="<%=name%>" class="board_write_input" /></td>
						</tr>
						<tr>
							<th>비밀번호</th>
							<td colspan="3"><input type="loginPassword" name="loginPassword"
								value="" class="board_write_input_100" /></td>
						</tr>
						<tr>
							<th>이메일</th>
							<td colspan="3"><input type="text" name="mail1"
								value="<%=mail[0]%>" class="board_write_input_100" /> @ <input
								type="text" name="mail2" value="<%=mail[1]%>"
								class="board_write_input_100" /></td>
						</tr>
					</table>
