...
<%@page import="MyBatisModelPagingModel.MyBatisPagingBoardDAO"%>
<%@page import="MyBatisModelPagingModel.MyBatisPagingBoardListTO"%>
...
<%
	...
	MyBatisPagingBoardListTO listTO = (MyBatisPagingBoardListTO) request.getAttribute("listTO");
	...
	// 현재 페이지의 목록
	ArrayList<MyBatisPagingBoardTO> boardlists = listTO.getBoardLists();

	// 받아온 목록을 StringBuffer에 저장하여 아래에서 보여주게 해준다.
	StringBuffer sbHtml = new StringBuffer();

	for (MyBatisPagingBoardTO to : boardlists) {
