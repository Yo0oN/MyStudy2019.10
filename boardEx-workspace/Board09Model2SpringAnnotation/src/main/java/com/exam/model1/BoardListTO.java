...
public class BoardListTO {
	...
	// DB에서 읽어온 목록을 저장하는곳
	private ArrayList<SimpleBoard01TO> boardLists;
	...
	public ArrayList<SimpleBoard01TO> getBoardLists() {
		return boardLists;
	}

	public void setBoardLists(ArrayList<SimpleBoard01TO> boardLists) {
