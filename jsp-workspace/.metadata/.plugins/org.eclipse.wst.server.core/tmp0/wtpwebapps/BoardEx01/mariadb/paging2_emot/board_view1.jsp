...
<%
	...
	try {
		...
		sql = "select subject, writer, mail, wdate, hit, content, emot from emot_board1 where seq = ?";
			...
			<div class="board_view">
				<table>
					<tr>
						<th width="10%">제목</th>
						<td width="60%">(<img
							src="../../images/emoticon/<%=emot%>.png" width="15" />)&nbsp;<%=subject%>
						</td>
						<th width="10%">등록일</th>
