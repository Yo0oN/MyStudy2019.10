...
<%
	...
	try {
		...
		String sql = "select subject, writer, mail, content, emot from board2 where seq = ?";
...
<script type="text/javascript">
	window.onload = function() {
		var emoticon = document.getElementsByName('emot');

		for (var i = 0; i < emoticon.length; i++) {
			if (emoticon[i].value == '<%= emot%>') {
			emoticon[i].checked = true;
			}
		}
								...
								<table>
									<tr>
										...
										<td><img src="../../images/emoticon/emot02.png"
											width="25" /><br /> <input type="radio" name="emot"
											value="emot02" class="input_radio" /></td>
