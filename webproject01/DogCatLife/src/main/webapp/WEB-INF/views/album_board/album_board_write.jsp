							...
							<form Method = "post" Enctype="multipart/form-date" name="frm">
								<div style = "padding: 1px 10px 1px 10px;">
									<table>
										...
										<tr>
											<td>제목&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="3"><input type="text" name="wsubject" value="" style="width:990px;"/></td>
										</tr>
										<tr>
											<td><br/></td>
										</tr>
										<tr>
											<td>내용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="3"><textarea name="wcontent" rows=40 cols=162 wrap="hard" style="resize:none;"></textarea></td>
										</tr>
										<tr>
											<td><br/></td>
										</tr>
								...
								<div class="btn_area">
									<div class="align_right" style="margin: 0px 100px 10px 0px;">		
										...
										&nbsp;&nbsp;
										<input type="button" value="작성" id="submit1" class="btn_write btn_txt01" style="cursor: pointer;" />
									</div>
								</div>
							</form>
						</div>
