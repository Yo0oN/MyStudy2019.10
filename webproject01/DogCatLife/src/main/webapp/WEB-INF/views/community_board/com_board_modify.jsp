							...
							<form Method="post" Enctype="multipart/form-date" name="frm">
								<div style="padding: 1px 10px 1px 10px;">
									<table>
										...
										<tr>
											<td>제목&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="3"><input type="text" name="msubject"
										...
										<tr>
											<td>내용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="3"><textarea name="mcontent" rows=40
													value="내용" cols=162 wrap="hard" style="resize: none;"></textarea></td>
										</tr>
										<tr>
											<td><br /></td>
										</tr>
								...
								<div class="btn_area">
									<div class="align_right" style="margin: 0px 100px 10px 0px;">
										...
										&nbsp;&nbsp; <input type="button" value="수정" id="submit1"
