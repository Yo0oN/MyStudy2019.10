				...
				<div class="col-lg-12">
					<div>
						<div class="contents_sub">
							...
							<form method="post" Enctype="multipart/form-date" id="frm"
								name="frm" action="./com_board_modify_ok.mysql">
								<input type="hidden" id="pseq" value="<%=pseq%>">
								<input type="hidden" id="writer" name="writer" value="작성자">
									...
									<table>
										...
										<tr>
											...
											<td colspan="3"><input type="text" id="subject"
												name="subject" value="" class="col-12" /></td>
										</tr>
										<tr>
											<td><br /></td>
										</tr>
										<tr>
											<td>내용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="3"><textarea class="col-12" name="content" id="content"
													rows=40 cols=162 wrap="hard" style="resize: none;"></textarea></td>
										</tr>
										<tr>
											<td><br /></td>
										</tr>
										<tr>
											<td>첨부&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="3"><input type="file" id="upload"
												name="upload" value="" class="board_write_input" /></td>
										</tr>
									</table>
								</div>
								<div class="btn_area">
