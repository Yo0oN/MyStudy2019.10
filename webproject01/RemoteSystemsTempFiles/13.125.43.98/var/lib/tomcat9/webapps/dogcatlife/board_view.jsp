					...
					<div class="single-post">
						...
						<div class="blog_details">
							...
							<ul class="blog-info-link mt-3 mb-4">
								<li><a href="#"><i class="fa fa-user"></i> 글쓴이글쓴이</a></li>
								<li><a href="#"><i class="fa fa-comments"></i> 댓글댓글댓글 Comments</a></li>
							</ul>
							...
							<p class="excert">내용내용내용내용내용
							아직 view는 디자인을 안정해서 임의로 수정중임</p>
							<p>이거도 내용인데 위에랑뭐가다른걸까</p>
							<!-- <div class="quote-wrapper">
								<div class="quotes">여기는 인용구같은거적으면좋을거같은데 view에서는 이런거안쓰죠</div>
							</div> -->
						</div>
					</div>
					<!-- 이전글 다음글 -->
