...
<body>
	...
	<header>
		<!-- 로고 -->
		<div class="col-12" style="text-align: center; margin: 50px">
						...
						<div class="main-menu d-none d-lg-block align-items-center">
							...
							<nav>
								<ul id="navigation">
									...
									<li><a href="#">찾아주세요</a>
										<ul class="submenu">
											<li><a href="#">실종동물등록</a></li>
											<li><a href="#">재회 성공 사례</a></li>
										</ul></li>
						...
						<div class="col-lg-7 col-md-9 ">
							<div class="hero__caption">
								<h1 data-animation="fadeInLeft" data-delay=".4s">
									We Collect<br> High Quality Leads
								</h1>
								<p data-animation="fadeInLeft" data-delay=".6s">Lorem ipsum
									dolor sit amet, consectetur adipiscing elit, sed do eiusmod
									tempor incididunt ut labore et dolore magna aliqua. Quis ipsum
									suspendisse ultrices gravi.</p>
								<!-- Hero-btn -->
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-do text-center mb-30">
						...
						<div class="do-caption">
							<h4>Link Building</h4>
							<p>Hunky dory barney fanny around up the duff no biggie loo
								cup of tea jolly good ruddy say arse!</p>
						</div>
						<div class="do-btn">
	...
	<!-- What We do End--> <!-- We Create Start -->
				...
				<div class="col-lg-6 col-md-12">
					<div class="we-create-cap">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
							...
							viverra maecenas accumsan lacus vel facilisis orem ipsum dolor
	...
	<!-- We Create End --> <!-- Generating Start -->
	<div class="generating-area ">
		<div class="container">
			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-8">
					<div class="section-tittle text-center">
						<h2>Generating New Customers Via Online Modeââ</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="single-generating d-flex mb-30">
						...
						<div class="generating-cap">
							...
							<p>Seddo eiusmod tempor incididunt labore lore magna aliqua
								uisipsum suspendis incididun se ultrices gravida.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
	...
	<!-- Generating End --> <!--Choose Best start-->
	...
	<!-- Choose Best do End--> <!-- Visit Stuffs Start -->
	...
	<!-- Visit Stuffs Start --> <!-- Testimonial Start -->
	...
	<!-- Testimonial End --> <!-- Tips Triks Start -->
	...
	<!-- Tips Triks End --> <!-- have-project Start-->
